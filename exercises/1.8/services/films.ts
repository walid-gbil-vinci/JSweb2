...
// prend en paramètre minimumDuration, qui est un nombre ou undefined. Par défaut, il est défini sur undefined.
//Elle retourne un tableau de films (Film[]), où chaque film a une propriété duration
...
const updateOne = (
  id: number, updatedFilm: Partial<NewFilm> ): Film | undefined => {
  const films = parse(jsonDbPath, defaultFilms);
